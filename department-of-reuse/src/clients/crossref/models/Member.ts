...
import {
    ...
    MemberPrefixToJSON,
    MembersMessageMessageItemsBreakdowns,
    MembersMessageMessageItemsBreakdownsFromJSON,
    MembersMessageMessageItemsBreakdownsFromJSONTyped,
    MembersMessageMessageItemsBreakdownsToJSON,
    MembersMessageMessageItemsCountsType,
    MembersMessageMessageItemsCountsTypeFromJSON,
    MembersMessageMessageItemsCountsTypeFromJSONTyped,
    MembersMessageMessageItemsCountsTypeToJSON,
    MembersMessageMessageItemsCoverageType,
    MembersMessageMessageItemsCoverageTypeFromJSON,
    MembersMessageMessageItemsCoverageTypeFromJSONTyped,
    MembersMessageMessageItemsCoverageTypeToJSON,
} from './';
...
export function MemberFromJSONTyped(json: any, ignoreDiscriminator: boolean): Member {
    ...
    return {
        ...
        'breakdowns': MembersMessageMessageItemsBreakdownsFromJSON(json['breakdowns']),
        'prefixes': json['prefixes'],
        'coverage': CoverageFullFromJSON(json['coverage']),
        'prefix': ((json['prefix'] as Array<any>).map(MemberPrefixFromJSON)),
        'id': json['id'],
        'tokens': json['tokens'],
        'countsType': MembersMessageMessageItemsCountsTypeFromJSON(json['counts-type']),
        'coverageType': MembersMessageMessageItemsCoverageTypeFromJSON(json['coverage-type']),
...
export function MemberToJSON(value?: Member | null): any {
    ...
    return {
        ...
        'breakdowns': MembersMessageMessageItemsBreakdownsToJSON(value.breakdowns),
        'prefixes': value.prefixes,
        'coverage': CoverageFullToJSON(value.coverage),
        'prefix': ((value.prefix as Array<any>).map(MemberPrefixToJSON)),
        'id': value.id,
        'tokens': value.tokens,
        'counts-type': MembersMessageMessageItemsCountsTypeToJSON(value.countsType),
        'coverage-type': MembersMessageMessageItemsCoverageTypeToJSON(value.coverageType),
