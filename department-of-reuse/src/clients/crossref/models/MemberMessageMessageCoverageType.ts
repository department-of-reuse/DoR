 ...
 * 
 * @export
 * @interface MemberMessageMessageCoverageType
 */
export interface MemberMessageMessageCoverageType {
    /**
     * 
     * @type {{ [key: string]: Coverage; }}
     * @memberof MemberMessageMessageCoverageType
     */
...
export function MemberMessageMessageCoverageTypeFromJSON(json: any): MemberMessageMessageCoverageType {
    return MemberMessageMessageCoverageTypeFromJSONTyped(json, false);
}

export function MemberMessageMessageCoverageTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemberMessageMessageCoverageType {
...
export function MemberMessageMessageCoverageTypeToJSON(value?: MemberMessageMessageCoverageType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
