 ...
 * 
 * @export
 * @interface MembersMessageMessageItemsCoverageType
 */
export interface MembersMessageMessageItemsCoverageType {
    /**
     * 
     * @type {{ [key: string]: Coverage; }}
     * @memberof MembersMessageMessageItemsCoverageType
     */
...
export function MembersMessageMessageItemsCoverageTypeFromJSON(json: any): MembersMessageMessageItemsCoverageType {
    return MembersMessageMessageItemsCoverageTypeFromJSONTyped(json, false);
}

export function MembersMessageMessageItemsCoverageTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembersMessageMessageItemsCoverageType {
...
export function MembersMessageMessageItemsCoverageTypeToJSON(value?: MembersMessageMessageItemsCoverageType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
