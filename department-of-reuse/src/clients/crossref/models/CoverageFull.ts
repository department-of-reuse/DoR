...
export function CoverageFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoverageFull {
    ...
    return {
        ...
        'openReferencesBackfile': json['open-references-backfile'],
        ...
        'openReferencesCurrent': json['open-references-current'],
        'referencesCurrent': json['references-current'],
    };
}

export function CoverageFullToJSON(value?: CoverageFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'open-references-backfile': value.openReferencesBackfile,
        ...
        'open-references-current': value.openReferencesCurrent,
