...
export function DepositFromJSONTyped(json: any, ignoreDiscriminator: boolean): Deposit {
    ...
    return {
        ...
        'matchedCitationCount': json['matched-citation-count'],
        'filename': json['filename'],
        'submittedAt': json['submitted-at'],
        'status': json['status'],
        'length': json['length'],
        'pingbackUrl': json['pingback-url'],
        'citationCount': json['citation-count'],
        'test': json['test'],
        'owner': json['owner'],
...
export function DepositToJSON(value?: Deposit | null): any {
    ...
    return {
        ...
        'matched-citation-count': value.matchedCitationCount,
        'filename': value.filename,
        'submitted-at': value.submittedAt,
        'status': value.status,
        'length': value.length,
        'pingback-url': value.pingbackUrl,
        'citation-count': value.citationCount,
        'test': value.test,
        'owner': value.owner,
