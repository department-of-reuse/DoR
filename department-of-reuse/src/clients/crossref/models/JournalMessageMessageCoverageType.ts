 ...
 * 
 * @export
 * @interface JournalMessageMessageCoverageType
 */
export interface JournalMessageMessageCoverageType {
    /**
     * 
     * @type {Coverage}
     * @memberof JournalMessageMessageCoverageType
     */
    all: Coverage;
    /**
     * 
...
export function JournalMessageMessageCoverageTypeFromJSON(json: any): JournalMessageMessageCoverageType {
    return JournalMessageMessageCoverageTypeFromJSONTyped(json, false);
}

export function JournalMessageMessageCoverageTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalMessageMessageCoverageType {
...
export function JournalMessageMessageCoverageTypeToJSON(value?: JournalMessageMessageCoverageType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
