 ...
 * 
 * @export
 * @interface JournalsMessageMessageItemsCoverageType
 */
export interface JournalsMessageMessageItemsCoverageType {
    /**
     * 
     * @type {Coverage}
     * @memberof JournalsMessageMessageItemsCoverageType
     */
    all: Coverage;
    /**
     * 
...
export function JournalsMessageMessageItemsCoverageTypeFromJSON(json: any): JournalsMessageMessageItemsCoverageType {
    return JournalsMessageMessageItemsCoverageTypeFromJSONTyped(json, false);
}

export function JournalsMessageMessageItemsCoverageTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalsMessageMessageItemsCoverageType {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'all': CoverageFromJSON(json['all']),
        'current': CoverageFromJSON(json['current']),
        'backfile': CoverageFromJSON(json['backfile']),
    };
}

export function JournalsMessageMessageItemsCoverageTypeToJSON(value?: JournalsMessageMessageItemsCoverageType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'all': CoverageToJSON(value.all),
        'current': CoverageToJSON(value.current),
        'backfile': CoverageToJSON(value.backfile),
    };
}
