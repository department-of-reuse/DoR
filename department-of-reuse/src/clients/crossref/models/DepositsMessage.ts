 ...
 * 
 * @export
 * @interface DepositsMessage
 */
export interface DepositsMessage {
    /**
     * 
     * @type {string}
     * @memberof DepositsMessage
     */
    status: string;
    /**
     * 
...
export function DepositsMessageFromJSON(json: any): DepositsMessage {
    return DepositsMessageFromJSONTyped(json, false);
}

export function DepositsMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): DepositsMessage {
    ...
    return {
        ...
        'message': DepositsFromJSON(json['message']),
    };
}

export function DepositsMessageToJSON(value?: DepositsMessage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'message': DepositsToJSON(value.message),
    };
}
