...
export function DepositMessageFromJSON(json: any): DepositMessage {
    return DepositMessageFromJSONTyped(json, false);
}

export function DepositMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): DepositMessage {
    ...
    return {
        ...
        'message': DepositFromJSON(json['message']),
    };
}

export function DepositMessageToJSON(value?: DepositMessage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'message': DepositToJSON(value.message),
    };
}
