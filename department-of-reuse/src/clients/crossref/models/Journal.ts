...
import {
    ...
    JournalsMessageMessageItemsBreakdowns,
    JournalsMessageMessageItemsBreakdownsFromJSON,
    JournalsMessageMessageItemsBreakdownsFromJSONTyped,
    JournalsMessageMessageItemsBreakdownsToJSON,
    JournalsMessageMessageItemsCoverageType,
    JournalsMessageMessageItemsCoverageTypeFromJSON,
    JournalsMessageMessageItemsCoverageTypeFromJSONTyped,
    JournalsMessageMessageItemsCoverageTypeToJSON,
} from './';
...
export function JournalFromJSONTyped(json: any, ignoreDiscriminator: boolean): Journal {
    ...
    return {
        ...
        'breakdowns': JournalsMessageMessageItemsBreakdownsFromJSON(json['breakdowns']),
        'publisher': json['publisher'],
        'coverage': CoverageFullFromJSON(json['coverage']),
        'title': json['title'],
        'subjects': json['subjects'],
        'coverageType': JournalsMessageMessageItemsCoverageTypeFromJSON(json['coverage-type']),
...
export function JournalToJSON(value?: Journal | null): any {
    ...
    return {
        ...
        'breakdowns': JournalsMessageMessageItemsBreakdownsToJSON(value.breakdowns),
        'publisher': value.publisher,
        'coverage': CoverageFullToJSON(value.coverage),
        'title': value.title,
        'subjects': value.subjects,
        'coverage-type': JournalsMessageMessageItemsCoverageTypeToJSON(value.coverageType),
