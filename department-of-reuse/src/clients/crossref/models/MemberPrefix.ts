...
export function MemberPrefixFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemberPrefix {
    ...
    return {
        ...
        'name': json['name'],
        'value': json['value'],
        'publicReferences': !exists(json, 'public-references') ? undefined : json['public-references'],
        'referenceVisibility': json['reference-visibility'],
    };
}

export function MemberPrefixToJSON(value?: MemberPrefix | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'name': value.name,
        'value': value.value,
        'public-references': value.publicReferences,
        'reference-visibility': value.referenceVisibility,
    };
}
