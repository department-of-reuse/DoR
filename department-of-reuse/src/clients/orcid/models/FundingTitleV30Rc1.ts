...
export function FundingTitleV30Rc1FromJSON(json: any): FundingTitleV30Rc1 {
    return FundingTitleV30Rc1FromJSONTyped(json, false);
}

export function FundingTitleV30Rc1FromJSONTyped(json: any, ignoreDiscriminator: boolean): FundingTitleV30Rc1 {
...
export function FundingTitleV30Rc1ToJSON(value?: FundingTitleV30Rc1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
