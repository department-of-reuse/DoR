...
import {
    ...
    InvitedPositionSummaryV30FromJSONTyped,
...
export function AffiliationGroupV30InvitedPositionSummaryV30FromJSON(json: any): AffiliationGroupV30InvitedPositionSummaryV30 {
    return AffiliationGroupV30InvitedPositionSummaryV30FromJSONTyped(json, false);
}

export function AffiliationGroupV30InvitedPositionSummaryV30FromJSONTyped(json: any, ignoreDiscriminator: boolean): AffiliationGroupV30InvitedPositionSummaryV30 {
    ...
    return {
        ...
        'summaries': !exists(json, 'summaries') ? undefined : ((json['summaries'] as Array<any>).map(InvitedPositionSummaryV30FromJSON)),
    };
}

export function AffiliationGroupV30InvitedPositionSummaryV30ToJSON(value?: AffiliationGroupV30InvitedPositionSummaryV30 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'summaries': value.summaries === undefined ? undefined : ((value.summaries as Array<any>).map(InvitedPositionSummaryV30ToJSON)),
    };
}
