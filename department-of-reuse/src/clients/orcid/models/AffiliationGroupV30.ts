...
import {
    ...
    AffiliationSummaryV30FromJSON,
    AffiliationSummaryV30FromJSONTyped,
    AffiliationSummaryV30ToJSON,
    ExternalIDsV30,
...
export function AffiliationGroupV30FromJSON(json: any): AffiliationGroupV30 {
    return AffiliationGroupV30FromJSONTyped(json, false);
}

export function AffiliationGroupV30FromJSONTyped(json: any, ignoreDiscriminator: boolean): AffiliationGroupV30 {
    ...
    return {
        ...
        'summaries': !exists(json, 'summaries') ? undefined : ((json['summaries'] as Array<any>).map(AffiliationSummaryV30FromJSON)),
    };
}

export function AffiliationGroupV30ToJSON(value?: AffiliationGroupV30 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'summaries': value.summaries === undefined ? undefined : ((value.summaries as Array<any>).map(AffiliationSummaryV30ToJSON)),
    };
}
