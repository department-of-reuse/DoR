...
import {
    ...
    EmploymentSummaryV30FromJSONTyped,
...
export function AffiliationGroupV30EmploymentSummaryV30FromJSON(json: any): AffiliationGroupV30EmploymentSummaryV30 {
    return AffiliationGroupV30EmploymentSummaryV30FromJSONTyped(json, false);
}

export function AffiliationGroupV30EmploymentSummaryV30FromJSONTyped(json: any, ignoreDiscriminator: boolean): AffiliationGroupV30EmploymentSummaryV30 {
    ...
    return {
        ...
        'summaries': !exists(json, 'summaries') ? undefined : ((json['summaries'] as Array<any>).map(EmploymentSummaryV30FromJSON)),
    };
}

export function AffiliationGroupV30EmploymentSummaryV30ToJSON(value?: AffiliationGroupV30EmploymentSummaryV30 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'summaries': value.summaries === undefined ? undefined : ((value.summaries as Array<any>).map(EmploymentSummaryV30ToJSON)),
    };
}
