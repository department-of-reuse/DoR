...
import {
    ...
    AffiliationSummaryV30Rc2FromJSON,
    AffiliationSummaryV30Rc2FromJSONTyped,
    AffiliationSummaryV30Rc2ToJSON,
    ExternalIDsV30Rc2,
...
export function AffiliationGroupV30Rc2FromJSON(json: any): AffiliationGroupV30Rc2 {
    return AffiliationGroupV30Rc2FromJSONTyped(json, false);
}

export function AffiliationGroupV30Rc2FromJSONTyped(json: any, ignoreDiscriminator: boolean): AffiliationGroupV30Rc2 {
    ...
    return {
        ...
        'summaries': !exists(json, 'summaries') ? undefined : ((json['summaries'] as Array<any>).map(AffiliationSummaryV30Rc2FromJSON)),
    };
}

export function AffiliationGroupV30Rc2ToJSON(value?: AffiliationGroupV30Rc2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'summaries': value.summaries === undefined ? undefined : ((value.summaries as Array<any>).map(AffiliationSummaryV30Rc2ToJSON)),
    };
}
