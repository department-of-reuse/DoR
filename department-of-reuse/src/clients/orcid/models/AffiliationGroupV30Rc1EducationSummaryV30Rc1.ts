...
import {
    ...
    EducationSummaryV30Rc1FromJSONTyped,
...
export function AffiliationGroupV30Rc1EducationSummaryV30Rc1FromJSON(json: any): AffiliationGroupV30Rc1EducationSummaryV30Rc1 {
    return AffiliationGroupV30Rc1EducationSummaryV30Rc1FromJSONTyped(json, false);
}

export function AffiliationGroupV30Rc1EducationSummaryV30Rc1FromJSONTyped(json: any, ignoreDiscriminator: boolean): AffiliationGroupV30Rc1EducationSummaryV30Rc1 {
    ...
    return {
        ...
        'summaries': !exists(json, 'summaries') ? undefined : ((json['summaries'] as Array<any>).map(EducationSummaryV30Rc1FromJSON)),
    };
}

export function AffiliationGroupV30Rc1EducationSummaryV30Rc1ToJSON(value?: AffiliationGroupV30Rc1EducationSummaryV30Rc1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'summaries': value.summaries === undefined ? undefined : ((value.summaries as Array<any>).map(EducationSummaryV30Rc1ToJSON)),
    };
}
